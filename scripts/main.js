...
const API_KEY = process.env.API_KEY ?? 'AIzaSyDoI3Q72rpy57OCFcMi2HDUMxIWPXI0afY';
const CHANNEL_ID = 'UCxIGNpsrjzWgY1Eyai1by3A';
...
function updateReadme(videos) {
  console.log(`vedeos ${videos.length}`);
